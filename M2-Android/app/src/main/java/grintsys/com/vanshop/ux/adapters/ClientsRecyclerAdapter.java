...
public class ClientsRecyclerAdapter extends RecyclerView.Adapter<ClientsRecyclerAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        public AppCompatTextView clientCardCode;
        public AppCompatTextView clientName;
        public AppCompatTextView clientPhone;
        private Client client;

        public ViewHolder(final Context context, View v, final ClientRecyclerInterface clientRecyclerInterface) {
            super(v);
            clientCardCode = v.findViewById(R.id.client_item_card_code);
            clientName =  v.findViewById(R.id.client_item_name);
            clientPhone = v.findViewById(R.id.client_item_phone);
