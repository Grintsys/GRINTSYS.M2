...
import grintsys.com.vanshop.entities.delivery.Branch;
import grintsys.com.vanshop.entities.delivery.BranchesRequest;
import grintsys.com.vanshop.entities.delivery.Delivery;
import grintsys.com.vanshop.entities.delivery.DeliveryType;
import grintsys.com.vanshop.entities.delivery.Shipping;
import grintsys.com.vanshop.interfaces.ShippingDialogInterface;
import grintsys.com.vanshop.listeners.OnSingleClickListener;
import grintsys.com.vanshop.utils.MsgUtils;
import grintsys.com.vanshop.ux.adapters.BranchesAdapter;
import grintsys.com.vanshop.ux.adapters.ShippingSpinnerAdapter;
...
public class ShippingDialogFragment extends DialogFragment {
    ...
    private void getOnlyBranches() {
        String url = String.format(SettingsMy.getActualTenant().getUrl() + EndPoints.BRANCHES, SettingsMy.getActualNonNullShop(getActivity()).getId());
