...
import grintsys.com.vanshop.ux.adapters.BannersRecyclerAdapter;
...
public class BannersFragment extends Fragment {
    ...
    private void loadBanners(String url) {
        ...
        if (url == null) {
            ...
            url = String.format(SettingsMy.getActualTenant().getUrl() + EndPoints.BANNERS, SettingsMy.getActualNonNullShop(getActivity()).getId());
        }
