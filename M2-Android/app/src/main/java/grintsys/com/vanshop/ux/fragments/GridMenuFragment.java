...
public class GridMenuFragment extends Fragment {
   ...
   /* private void replaceFragment(Fragment newFragment, String transactionTag) {
    ...
    public void getBadgeCount(){
        GsonRequest<MainMenu> getProductRequest = new GsonRequest<>(Request.Method.GET, SettingsMy.getActualTenant().getUrl() + EndPoints.MAIN_MENU_BADGE_COUNT, null, MainMenu.class,
