...
import grintsys.com.vanshop.interfaces.ProductImagesRecyclerInterface;
import grintsys.com.vanshop.interfaces.RelatedProductsRecyclerInterface;
...
import grintsys.com.vanshop.ux.adapters.ColorSpinnerAdapter;
import grintsys.com.vanshop.ux.adapters.ProductImagesRecyclerAdapter;
import grintsys.com.vanshop.ux.adapters.SizeVariantSpinnerAdapter;
...
import grintsys.com.vanshop.ux.dialogs.ProductImagesDialogFragment;
    ...
    private void prepareQuantityButton(View view){
        ...
        plusImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Validacion para bloquear cantidades negativas del disponible NOV 1st DEM:
                //if ( Integer.valueOf(productIsCommited.getText().toString()) - Integer.valueOf(quantityEditText.getText().toString()) >= 0 )
                //{
                    quantityEditText.setText(String.valueOf(++quantity));
                //}
...
//                    Timber.e("scrollY:" + scrollY + ". Alpha:" + alphaRatio);
    ...
    private void getProduct(final long productId) {
        String url = String.format(SettingsMy.getActualTenant().getUrl() + EndPoints.PRODUCTS_SINGLE_RELATED, productId);
    ...
    private void postProductToCart() {
        ...
        if (user != null) {
            ...
            if(tenant == null)
                return;
            String url = String.format(EndPoints.CART_ADD_ITEM, tenant.getId(), selectedProductVariant.getId(), quantity, card_code);
            ...
            MyApplication.getInstance().addToRequestQueue(addToCart, CONST.CART_ADD_ITEM);
        } else {
    ...
    private void refreshView(){
        ...
        contentScrollLayout.setVisibility(View.VISIBLE);
        contentScrollLayout.clearAnimation();
        //quantityEditText = (EditText) view.findViewById(R.id.quantity_edittext);
