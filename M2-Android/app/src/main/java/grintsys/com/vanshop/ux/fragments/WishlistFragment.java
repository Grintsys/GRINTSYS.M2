...
import grintsys.com.vanshop.entities.wishlist.WishlistResponse;
import grintsys.com.vanshop.interfaces.RequestListener;
import grintsys.com.vanshop.interfaces.WishlistInterface;
...
import grintsys.com.vanshop.ux.adapters.WishListRecyclerAdapter;
...
public class WishlistFragment extends Fragment {
    ...
    public static void addToWishList(final FragmentActivity activity, long variantId, User user, String requestTag, final RequestListener requestListener) {
        if (activity != null && variantId != 0 && user != null && requestTag != null && requestListener != null) {
            String url = String.format(SettingsMy.getActualTenant().getUrl() + EndPoints.WISHLIST_CREATE, user.getId(), variantId);
