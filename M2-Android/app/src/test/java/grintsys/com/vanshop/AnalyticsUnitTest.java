...
import grintsys.com.vanshop.entities.cart.CartProductItemVariant;
...
public class AnalyticsUnitTest {
    ...
    Tenant testTenant = new Tenant("testTenant", "UA-test");
    ...
    private void prepareMockedFields() throws Exception {
        ...
        when(mockAnalytics.newTracker(testTenant.getGoogleUa())).thenReturn(mockTrackerApp);
    }
    ...
    public void prepareTrackersAndFbLoggerTest() throws Exception {
        ...
        // Tested method invocation
        Analytics.prepareTrackersAndFbLogger(testTenant, mockContext);
        ...
        verify(mockAnalytics, times(1)).newTracker(testTenant.getGoogleUa());
        verify(mockAnalytics, times(1)).newTracker(R.xml.global_tracker);
    ...
    public void logShopChangeTest() throws Exception {
        ...
        Tenant testTenant1 = new Tenant("shop1", null);
        Tenant testTenant2 = new Tenant("shop2", null);

        Analytics.logShopChange(testTenant1, testTenant2);
    ...
    public void logOrderCreatedEventTest() throws Exception {
        ...
        doReturn(testTenant).when(SettingsMy.class, "getActualNonNullShop", any());
