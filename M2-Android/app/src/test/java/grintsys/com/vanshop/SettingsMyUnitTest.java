...
public class SettingsMyUnitTest {
    ...
    public void getActualShopTest() throws Exception {
        ...
        when(mockSharedPreferences.getString(SettingsMy.PREF_ACTUAL_SHOP, "")).thenReturn(Utils.getGsonParser().toJson(testTenant));

        // Check if value is returned
        assertEquals(SettingsMy.getActualTenant(), testTenant);
    }
    ...
    public void getActualShopNullTest() throws Exception {
        ...
        // Check if value is returned
        assertEquals(SettingsMy.getActualTenant(), null);
    }
    ...
    public void setAndGetActualShopTest() throws Exception {
        ...
        SettingsMy.setActualTenant(testTenant);
        verify(mockEditor, times(1)).putString(SettingsMy.PREF_ACTUAL_SHOP, Utils.getGsonParser().toJson(testTenant));
    ...
    public void setAndGetActualShopNullTest() throws Exception {
        ...
        // Set actual shop and check method calls
        SettingsMy.setActualTenant(null);
    ...
    public void getActualNonNullShopErrorTest() throws Exception {
        ...
        // Check return value
        assertEquals(SettingsMy.getActualNonNullShop(mockActivity), new Tenant());
    ...
    public void getActualNonNullShopOkTest() throws Exception {
        ...
        // Check return value
        assertEquals(SettingsMy.getActualNonNullShop(mockActivity), testTenant);
