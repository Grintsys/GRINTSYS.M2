...
public class activity_rventas_diarias extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rventas_diarias);


        WebView myWebView = (WebView) findViewById(R.id.wvDespachos);
        myWebView.loadUrl("http://181.199.177.162/SVKAD/RVentasDiarias");
    }
