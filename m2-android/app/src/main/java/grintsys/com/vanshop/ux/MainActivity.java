...
import grintsys.com.vanshop.RCobrosDiarios;
import grintsys.com.vanshop.SettingsMy;
import grintsys.com.vanshop.activity_rventas_diarias;
...
import grintsys.com.vanshop.entities.cart.CartInfo;
...
import grintsys.com.vanshop.ux.fragments.SuggestedInventoryFragment;
...
public class MainActivity extends AppCompatActivity implements DrawerFragment.FragmentDrawerListener {
    ...
    public void AddInvoice(Document item){
        ...
        if(!exist) {
            ...
            i.setPayedAmount(item.getPayedAmount());
...
//        http://stackoverflow.com/questions/12529499/problems-with-android-fragment-back-stack
    ...
    public void onRefundSelected() {
        ...
        Timber.d("onRefundSelected");

        Fragment fragment = InvoiceHistoryFragment.newInstance();
    ...
    //DEM August 21st - 2017
    public void onTakeInventorySelected() {

        Timber.d("onTakeInventorySelected");

       // startActivity(new Intent(getApplicationContext(), TakeInventoryFragment.class));
    ...
    //DEM August 24th - 2017
    public void onDespachoSelected() {

        Timber.d("onTakeDespachoSelected");
    ...
    public void onVisitasVentasSelected () {
        Timber.d("onVisitasVentasSelected");

         startActivity(new Intent(getApplicationContext(), TakeInventoryFragment.class));
        // Start NewActivity.class
         Intent myIntent = new Intent(MainActivity.this,
                activity_rventas_diarias.class);
        startActivity(myIntent);
    }

    public void onVisitasCobrosSelected () {
        Timber.d("onVisitasCobrosSelected");

         startActivity(new Intent(getApplicationContext(), TakeInventoryFragment.class));
        // Start NewActivity.class
        Intent myIntent = new Intent(MainActivity.this,
                RCobrosDiarios.class);
        startActivity(myIntent);
    }


    public void onSuggestedInventorySelected() {

        Timber.d("onSuggestedInventorySelected");
